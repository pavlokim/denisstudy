...
<fiche>
  ...
  <documentFondamental><?php print $data->fondamental; ?></documentFondamental>
  <?php if ($data->date) : ?>
    <date><?php print $data->date; ?></date>
  <?php else : ?>
    <?php print _batire_antidot_export_xml_tag('date'); ?>
  <?php endif; ?>
  <?php if ($data->date_sign) : ?>
    <dateSignature><?php print $data->date_sign; ?></dateSignature>
  <?php else : ?>
    <?php print _batire_antidot_export_xml_tag('dateSignature'); ?>
  <?php endif; ?>
  <?php if ($data->date_pub) : ?>
    <datePublication><?php print $data->date_pub; ?></datePublication>
  <?php else : ?>
    <?php print _batire_antidot_export_xml_tag('datePublication'); ?>
  <?php endif; ?>
  <numeroRef><?php print $data->numero_ref; ?></numeroRef>
  <position><?php print $data->position; ?></position>
  <?php if ($data->nor_num) : ?>
    <nor><?php print $data->nor_num; ?></nor>
  <?php endif; ?>
