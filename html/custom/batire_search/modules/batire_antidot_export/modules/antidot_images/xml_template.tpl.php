...
<fiche>
  ...
  <?php endif; ?>
  <?php if ($data->type_rubrique) : ?>
    <rubrique id="<?php print $data->type_rubrique['id']; ?>" priorite="<?php print $data->type_rubrique['priorite']; ?>"><?php print $data->type_rubrique['name']; ?></rubrique>
  <?php else : ?>
    <?php print _batire_antidot_export_xml_tag('rubrique'); ?>
  <?php endif; ?>
  ...
  <image_id><?php print $data->image_id; ?></image_id>
  <?php endif; ?>
  <?php if ($data->image_path) : ?>
    <image_path><?php print $data->image_path; ?></image_path>
  <?php endif; ?>
  <?php if ($data->image_title) : ?>
    <image_title><?php print $data->image_title; ?></image_title>
  <?php endif; ?>
  <?php if ($data->image_legend) : ?>
    <image_legend><?php print $data->image_legend; ?></image_legend>
  <?php endif; ?>
  <?php if ($data->document_id) : ?>
    <document_id><?php print $data->document_id; ?></document_id>
  <?php endif; ?>
  <?php if ($data->document_url) : ?>
    <document_url><?php print $data->document_url; ?></document_url>
  <?php endif; ?>
  <?php if ($data->document_title) : ?>
    <document_title><?php print $data->document_title; ?></document_title>
  <?php endif; ?>
  <?php if ($data->other_title) : ?>
    <other_title><?php print $data->other_title; ?></other_title>
  <?php endif; ?>
  <?php if ($data->image_type) : ?>
    <image_type><?php print $data->image_type; ?></image_type>
  <?php endif; ?>
